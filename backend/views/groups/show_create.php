...
<section class="content-header">
    <h1>
        Crear Nuevo Grupo
        <small>Aqui puede crear nuevos grupos de envios</small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                <form id="groupForm" action="<?= base_url() ?>admin.php/groups/create" name="groupForm" method='POST' enctype="multipart/form-data" onsubmit="post_submit()">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3>Pagina para crear grupos de envio</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">

                            <div class="form-group">
                                <label for="groupName">Nombre del Grupo</label>
                                <input type="text" required id="groupName" class="form-control" name="groupName" value="<?= set_value("groupName") ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="10" class="form-control" id="phoneNumbers" name="phoneNumbers" placeholder="Ingrese su numero en Formato internacional"><?php echo set_value('phoneNumbers'); ?></textarea>
                            </div>
                            <div class="form-group">
