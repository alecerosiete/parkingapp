...
class Layout {
   ...
   */
  // Title de la pagina
  public $title = 'Parking';
  // palabras claves de la pagina
  public $keywords = 'Parking';
  // description
  public $description = 'Parking';
  ...
  function view($view = null, $data = null, $return = false) {
    ...
    $load_view = array(
        'layout_headers' => $this->element('headers', null, true),
        'layout_menu' => $this->element('menu', $data, true),
        'layout_aside' => $this->element('aside', $data, true),
        'layout_content' => $this->CI->load->view($vista, $data, true),
        'layout_footer' => $this->element('footer', $data, true),
        'layout_control_sidebar' => $this->element('control-sidebar', $data, true)        
    );
  ...
  public function element($view = null, $data = null, $return = false) {
    $element = "layouts/elements/{$view}";
    //$content_for_menu	= array('data'=> $data);

    if ($return) {
      return $this->CI->load->view($element, $data, true);
    } else {
      $this->CI->load->view($element, $data, false);
    }
  }
