jQuery(document).ready(function(a){
    a(".recent-properties-inner").each(function(){
        var d=a(this);
        var c={
            responsive:true,
            circular:false,
            infinite:true,
            auto:{
                play:true,pauseOnHover:true
            },
            prev:d.find(".caroufredsel-prev"),
            next:d.find(".caroufredsel-next"),
            swipe:{onTouch:true},
            scroll:{items:1,duration:600,fx:"scroll",timeoutDuration:2000,easing:"swing"},
            items:{visible:1}
        };
        d.find("ul").carouFredSel(c);
        imagesLoaded(d,function(){d.find("ul").trigger("updateSizes")});
        a(window).resize(function(){d.find("ul").trigger("destroy").carouFredSel(c)})
    });
    ...
    a(".recent-agents-slider").each(function(){
        ...
        var c={
            ...
            swipe:{
                ...
                duration:600,
                fx:"scroll",
                timeoutDuration:2000,easing:"swing"
            },
            items:{
                height:"variable",
                visible:{min:1,max:3}
    ...
    a(".recent-properties-featured").each(function(){
        ...
        var c={
            ...
            swipe:{onTouch:true},
            scroll:{
                items:1,duration:600,fx:"scroll",
                timeoutDuration:2000,easing:"swing"
            },
    ...
    function caroufredselImage(){
        if($('.property-featured .images').length){
            $(".property-featured .images .caroufredsel-wrap ul").carouFredSel({
                responsive:true,
                auto:{
                    play:false,pauseOnHover:true},
                pagination:{
                    container:".thumbnails .thumbnails-wrap ul",anchorBuilder:false}});
        }}
